...
//   // match get_worker_by_uuid_mysql(pooled_conn, uuid) {
//   //   Ok(mut worker) => {
//   //     worker.difficulty = difficulty;
//   //     match update_worker_mysql(pooled_conn, &worker) {
//   //       Ok(_) => (),
//   //       Err(e) => println!("Worker ({}) difficulty update failed: {}", worker.id, e),
//   //     };
//   //   }
//   //   Err(e) => println!(
//   //     "Worker not found in difficulty update: {}, uuid: {}",
//   //     e, &uuid
//   //   ),
//   // }
// }
